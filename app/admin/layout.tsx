    ...
    return (
      <div className="mx-auto max-w-md text-center">
        ...
        <form action={logout} className="mt-4">
          <button className="rounded border border-gray-300 px-4 py-2 text-sm" type="submit">
            Sign out
          </button>
        </form>
      </div>
    ...
    <div className="grid gap-8 md:grid-cols-[200px_1fr]">
      <nav className="space-y-1">
        ...
        <form action={logout} className="pt-4">
          <button className="w-full rounded px-3 py-2 text-left text-sm text-gray-500 hover:bg-gray-100" type="submit">
            Sign out
          </button>
        </form>
      </nav>
